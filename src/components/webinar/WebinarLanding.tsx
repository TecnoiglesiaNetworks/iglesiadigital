  ...
  return (
    <div className="relative z-10">
      ...
      <section className="container grid items-center gap-10 py-16 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
        ...
        {/* Columna derecha: tarjeta de registro (al enviar redirige a /listo) */}
        <div className="lg:sticky lg:top-24">
          <RegistrationCard slug={cfg.slug} />
        </div>
      </section>
...
function RegistrationCard({ slug }: { slug: string }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      // Redirige a la pantalla enfocada del Paso 2 (grupo de WhatsApp). Usamos
      // replace para que "atrás" no regrese al formulario ya enviado.
      router.replace(`/webinar/${slug}/listo`);
    }
  }
